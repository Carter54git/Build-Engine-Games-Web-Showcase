/* Browser save persistence for PCExhumed (saveN.gam). */
(function (global) {
  'use strict';
  var CREATE = 'createPCExhumedModule';
  var SCRIPT_RE = /pcexhumed\.js/i;
  var DB_NAME = 'pcexhumed-saves-v1';
  var STORE = 'files';
  var savCache = null;
  var prefetchPromise = null;
  function isSaveName(name) { return /^save\d\.gam$/i.test(name); }
  function openDb() {
