...
(function (global) {
  ...
  function prefetchSaves() {
    ...
    prefetchPromise = readAllFromDb()
      ...
      .catch(function (e) {
        console.warn('[NAM] prefetch saves failed:', e);
        savCache = savCache || {};
        return savCache;
      });
  ...
  function restoreCacheToFs(Module) {
    ...
    for (var key in savCache) {
      ...
      try {
        ...
        console.warn('[NAM] restore save:', key, e);
      }
    }
  }
  ...
  function loadIntoFs(Module, done) {
    ...
    readAllFromDb().then(function (out) {
      ...
      console.warn('[NAM] IndexedDB load failed:', e);
      done();
    });
  }
  ...
  function persistFromFs(Module, done) {
    ...
    openDb().then(function (db) {
      ...
      for (var i = 0; i < names.length; i++) {
        ...
        (function (n) {
          try {
            ...
            console.warn('[NAM] persist save:', n, e);
          }
          left--;
          if (left <= 0) finish();
        })(names[i]);
      ...
      console.warn('[NAM] IndexedDB save failed:', e);
      done();
    });
  }
