/* Browser save persistence for ETekWar (savegamN.tek). */
(function (global) {
  'use strict';
  var CREATE = 'createETekwarModule';
  var SCRIPT_RE = /etekwar\.js/i;
  var DB_NAME = 'etekwar-saves-v1';
  var STORE = 'files';
  var savCache = null;
  var prefetchPromise = null;
  function isSaveName(name) { return /^savegam\d+\.tek$/i.test(name); }
  function openDb() {
